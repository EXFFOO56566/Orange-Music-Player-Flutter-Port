...
import 'package:songapp/screens/payment/CustomToast.dart';
                    ...
                    (context) => Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            //Height of playlist item causing error
              ...
              GestureDetector(
                onTap: () {
                  if (Networkutils.download == 1) {
                    _download();
                    //Removed download functionality temporarily
                    //in commented out codes
                  } else {showToast();
    //else {
    //Navigator.of(context).push(
    //MaterialPageRoute(
    //create: (context) => ChoosePlanScreen(),
    //),
    //);
...
void showToast() => Fluttertoast.showToast(
  msg: "Downloads not available for this file",
  toastLength: Toast.LENGTH_LONG,
  gravity: ToastGravity.BOTTOM,
  timeInSecForIosWeb: 1,
);
