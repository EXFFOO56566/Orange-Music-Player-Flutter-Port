  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //comment out from here replace with logo and recompile
        leading: GestureDetector(
        //put back commented out code here check commented out.dart file in code snippets
          child: Padding(
            padding: EdgeInsets.all(13),
            child: Container(
              child: Image.asset(
                StaticData.imagepath + 'playstore.png',
              ),
